...
export class AuthController {
  ...
  @ApiResponse({
    ...
    schema: { example: { status: 'error', message: 'User not found' } },
  })
  async forgetPassword(@Body() dto: forgotPasswordDto, @Res() res: Response) {
    await this.authService.forgetPassword(dto, res);
  }
  ...
  @ApiResponse({
    ...
    schema: { example: { status: 'success', message: 'Password reset successful' } },
  })
  @ApiResponse({
    status: HttpStatus.INTERNAL_SERVER_ERROR,
    description: 'Reset password failed',
    schema: { example: { status: 'error', message: 'Reset password failed' } },
  })
  async resetPassword(
    ...
    await this.authService.resetPassword(dto, email, res);
  }
}